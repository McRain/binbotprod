import{A as e,D as t,E as n,N as r,O as i,Q as a,S as o,_ as s,a as c,b as l,c as u,d,f,g as p,h as ee,i as m,s as h,t as g,v as _,w as v}from"./runtime-core.esm-bundler-8J4_mGIa.js";import{_ as y,d as b,g as x,h as S,l as C,m as te,s as ne,t as re}from"./index-B_Lojyrw.js";import{t as w}from"./Spinner-Dr3uwY7u.js";function T(e){let t=document.createElement(`span`);return t.textContent=e,t.innerHTML}function E(e,t,n){let{onClickAdd:r,onDragStart:i}=n;e.innerHTML=`
    <h3 class="rb-sidebar-title">ШАБЛОНЫ</h3>
    <div class="rb-template-list">${Object.entries(t).map(([e,t])=>{let n=T(t.icon||`◆`),r=T(t.title),i=T(t.description||``);return`<div class="rb-template-item" data-template="${T(e)}" draggable="true">
  ...
  `,e.querySelectorAll(`.rb-template-item`).forEach(e=>{e.addEventListener(`click`,()=>r(e.dataset.template)),e.addEventListener(`dragstart`,t=>{t.dataTransfer.effectAllowed=`copy`,i(e.dataset.template)})})}var D=`// renderer.worker.js — OffscreenCanvas Web Worker for node editor rendering\r
\r
...
`,O=`/* reneos-blocks — scoped component styles */\r
\r
.reneos-blocks {\r
